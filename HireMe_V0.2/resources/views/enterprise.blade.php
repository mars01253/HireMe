    ...
    @if (auth()->user()->confirm == 1)
        ...
        <form action="{{ route('offer.create') }}" method="POST" class="mt-3 w-[50%] m-auto flex flex-col gap-2"
            ...
            <div class="flex gap-1 ">
                ...
                <div class="flex flex-col w-1/2">
                    <input type="text" id="Skills" name="skills" value="{{ old('skills') }}"
                        placeholder="please separate skills by commas" class="border-none py-2 px-8 rounded-xl">
                    @error('Skills')
                        <p class="text-red-500">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="flex flex-col">
                ...
                <input type="text-area" id="description" name="description" value="{{ old('description') }}"
                    placeholder="Description" class="border-none py-5 px-8 rounded-xl">
                @error('description')
                    <p class="text-red-500">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex flex-col">
                <label for="country" class="font-bold">Location</label>
...
<div class=" w-full flex flex-wrap gap-2 m-auto mt-5 mb-2 justify-center">
    ...
    <div
        ...
        <div class="z-10 flex flex-col justify-evenly w-full h-full">
            ...
            <a href="{{route('offer.candidates', [$offer->id])}}" class="hover:bg-blue-200 bg-neutral-50 rounded text-neutral-800 text-center font-extrabold w-full p-2">
                See Candidates
            </a>
